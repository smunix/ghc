...
module GHC.Parser.Annotation (
  ...
  LocatedA, LocatedL, LocatedC, LocatedN, LocatedAn,
...
addTrailingAnnToA :: SrcSpan -> AnnKeywordId -> ApiAnn' AnnListItem -> RealSrcSpan -> ApiAnn' AnnListItem
addTrailingAnnToA s kw ApiAnnNotUsed l = ApiAnn (realSrcSpan s) (AnnListItem [AddApiAnn kw l]) []
addTrailingAnnToA _ kw n l = n { anns = addTrailingComma' (anns n) l }
  where
    addTrailingComma' n l = n { lann_trailing = AddApiAnn kw l : lann_trailing n }

addTrailingCommaToN :: SrcSpan -> ApiAnn' NameAnn -> RealSrcSpan -> ApiAnn' NameAnn
addTrailingCommaToN s ApiAnnNotUsed l = ApiAnn (realSrcSpan s) (NameAnnTrailing [AddApiAnn AnnComma l]) []
addTrailingCommaToN _ n l = n { anns = addTrailingComma' (anns n) l }
  where
